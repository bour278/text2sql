...
ohlc_df.to_sql('ohlc', conn, if_exists='append', index=False)
...
fxrates_df.to_sql('fxrates', conn, if_exists='append', index=False)
...
treasury_yields_df.to_sql('treasury_yields', conn, if_exists='append', index=False)
